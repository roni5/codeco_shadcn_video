export default function DarkFooter() {
	return (
		<section className=" text-gray-900 dark:bg-neutral-50 dark:text-gray-900">
			<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600">
				<ul className="self-center py-6 space-y-4 text-center text-neutral-950  sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
					<li>Terms</li>
					<li>About</li>
					<li>Privacy</li>
					<li>Pricing</li>
