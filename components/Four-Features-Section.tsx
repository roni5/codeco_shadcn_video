...
export default function FourSection() {
  return (
    <>
      <section
        id="features"
        className="py-24  md:py-32 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-slate-950 via-neutral-900 to-slate-950"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16">
            <button
              type="button"
              className="px-8 py-4 bg-linear-to-br from-slate-900 to-indigo-950 text-white rounded-xl text-lg font-semibold hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-300"
            >
