export default function ChatBubbleUpload() {
	return (
		<>
			<div className="flex items-start gap-2.5">
				{/* Fixed img self-closing tag */}
				<img className="w-8 h-8 rounded-full" src="/img/ryan.jpg" alt="ryan" />
				<div className="flex flex-col gap-1">
					{/* Main bubble container - using max-w-lg to allow it to expand */}
					<div className="flex flex-col w-full max-w-lg leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
						...
						{/* THIS IS THE KEY CHANGE: Added min-w-[280px] to force wider content area */}
						<div className="flex items-start my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2 min-w-[280px]">
							<div className="me-2">
...
//                     viewBox="0 0 20 21"
//                   >
//                     <g clip-path="url(/chatclip0_3173_1381)">
//                       <path
//                         fill="#E2E5E7"
//                         d="M5.024.5c-.688 0-1.25.563-1.25 1.25v17.5c0 .688.562 1.25 1.25 1.25h12.5c.687 0 1.25-.563 1.25-1.25V5.5l-5-5h-8.75z"
//                       />
...
//                      <circle cx="1.5" cy="2" r="1.5" fill="/chat6B7280"/>
//                   </svg>
//                   18 MB
//                   <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="self-center" width="3" height="4" viewBox="0 0 3 4" fill="none">
//                      <circle cx="1.5" cy="2" r="1.5" fill="/chat6B7280"/>
