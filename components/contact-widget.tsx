    ...
    <div className="relative z-50">
      ...
      {open && (
        <>
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-sky-400 to-pink-400  text-white px-4 py-3 flex items-center gap-2">
          ...
          <div className="border-t border-slate-200 p-3 bg-white flex gap-2 items-end">
            ...
            <button
              ...
              className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-sky-400 to-pink-400 text-white rounded-full flex items-center justify-center ring-1 ring-black/5 dark:ring-white/10 shadow-[0_8px_24px_rgba(2,8,23,0.25)] hover:shadow-[0_16px_40px_rgba(2,8,23,0.32)] transition-transform duration-300 hover:-translate-y-0.5 focus:outline-none"
            >
      ...
      <button
        ...
        className="fixed z-[70] right-5 bottom-5 flex justify-center items-center w-14 h-14 rounded-full bg-gradient-to-r from-sky-400 to-pink-400 text-white ring-1 ring-black/5 dark:ring-white/10 shadow-[0_16px_48px_rgba(2,8,23,0.30)] hover:shadow-[0_28px_72px_rgba(2,8,23,0.38)] transition-transform duration-300 hover:-translate-y-1 focus:outline-none"
      >
        {open ? (
          <svg
