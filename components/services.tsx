...
export default function Service() {
	...
	return (
		<section className=" pb-3 md:pb-12 pt-2 md:pt-20 bg-neutral-950 overflow-hidden lg:pb-[90px] lg:pt-[120px]">
			<div className="container mx-auto px-4 ">
				<div className="-mx-4 flex flex-wrap">
					<div className="w-full px-4">
						<div className="mx-auto mb-12 md:mb-16 max-w-[510px] text-center lg:mb-20">
							<span className="mb-2 block text-lg font-semibold text-white">
								Our Services
							</span>
							<h1
								data-splitting
								className="mb-3 text-3xl font-bold leading-[1.2] text-white sm:text-4xl md:text-[40px] antialiased"
							>
								What We Offer
							</h1>
...
//     <>
//       <div className="w-full px-4 md:w-1/2 lg:w-1/3">
//         <div className="group mb-9  bg-white p-10 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10 group backdrop-blur-sm rounded-2xl  hover:bg-slate-800/80 transition-all duration-300 border border-slate-700/50 hover:border-cyan-500/50">
//           <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-gray-900">
//             {icon}
//           </div>
//           <h4 className="mb-3.5 text-2xl font-semibold text-dark hover:text-white">
//             {title}
//           </h4>
//           <p className="text-slate-950 hover:text-white">{details}</p>
//         </div>
//       </div>
//     </>
//   )
