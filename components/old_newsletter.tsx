...
import type  {  useTransition, HTMLAttributes } from 'react'
...
export default function Newsletters({ className, transition }: NewsProps) {
  ...
  }, [formState.status, formState.form.email, formState.errors, router.push])
    ...
    <div>
      ...
      <section className="relative py-0 md:py-6 overflow-hidden">
        <div className="container px-4 mx-auto">
          <div className="relative max-w-7xl pt-2 pb-2 md:pb-0 md:pt-0 px-6 md:px-16 mx-auto">
              ...
              <div className="w-full lg:w-1/2 px-4  ml-0 md:-ml-20   mt-0 md:-mt-5">
                <form ref={formRef} action={handleFormSubmit}>
                  <div className="max-w-lg lg:ml-auto">
                    <div className="full-width sm:flex mb-2 items-center text-gray-700">
                      <input
                        type="email"
                        id="email"
                        name="email"
                        ...
                        className="w-full  relative group inline-block flex-shrink-0 sm:w-auto py-2 px-5 text-md font-semibold text-gray-700 bg-white-50 rounded-md overflow-hidden  mb-3 sm:mb-0 sm:mr-4  text-sm text-codeco-blue placeholder-gray-400 border border-gray-200 focus:border-pelorous-600 focus:outline-pelorous-500 "
...
function SubmitButton({
  ...
  return (
    <button
      ...
      className="relative group inline-flex flex-shrink-0 w-full sm:w-auto py-2 px-5 text-md font-semibold text-slate-50 bg-pelorous-500 rounded-md overflow-hidden shadow-xl/20 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-pelorous-500 focus:ring-offset-2 transition-all duration-200"
      type="submit"
    >
