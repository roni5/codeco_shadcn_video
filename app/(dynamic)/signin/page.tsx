            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-700">View Services</span>
                    </Link>
                    <Link
                      href="/blog"
                      className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition"
                    >
                      ...
                      <span className="text-sm text-gray-700">Read Blog Posts</span>
                    </Link>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <Card className="bg-white/95 backdrop-blur border-0 shadow-lg p-6">
                  ...
                  <h3 className="font-bold text-gray-900 text-lg mb-2">All Set</h3>
                  <p className="text-sm text-gray-600">You're signed in and ready to explore.</p>
                </Card>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <Card className="lg:col-span-2 bg-white/95 backdrop-blur border-0 shadow-2xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-3xl font-bold text-gray-900">Sign in to Codeco</CardTitle>
                <CardDescription className="text-base text-gray-600 mt-2">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white px-2 text-gray-500">Trusted by thousands</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-gray-900">Secure Authentication</p>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-sm text-gray-900">Fast Access</p>
            ...
            <div className="space-y-4">
              ...
              <Card className="bg-white/95 backdrop-blur border-0 shadow-lg p-6">
                ...
                <h3 className="font-bold text-gray-900 text-lg mb-2">Secure & Private</h3>
