...
const categories = ['Development', 'Design', 'Backend', 'DevOps', 'Cloud Architecture'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">Insights from the engineering team.</p>
            </div>
                      ...
                      <div className="p-6 flex flex-col justify-between grow">
                        <div>
                          <div className="flex items-center gap-x-3 text-xs font-semibold text-blue-600 uppercase tracking-wide">
                            ...
                            <span className="text-gray-500 font-normal normal-case">{post.date}</span>
                          </div>
                        ...
                        <div className="mt-5 flex items-center justify-between">
                          ...
                          <span className="text-blue-600 text-sm font-medium group-hover:underline">Read Article &rarr;</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-12 text-center">
                <button type="button" className="py-3 px-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 hover:text-blue-600 transition-all">
                  Load more articles
                </button>
            </div>
          </div>
