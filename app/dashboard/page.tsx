...
//   // Source of truth: DB role (avoids relying on session augmentation)
...
// export default async function DashboardPage() {
//   // Dynamic import to handle both named and default exports without breaking
...
//     throw new Error("Auth module does not export a callable 'auth' function")
//   }

//   const session: Session | null = await authFn()
...
//   // Fetch data in parallel (only if admin)
//   const [allContacts, allNewsletters] = await Promise.all([
//     getContacts(),
//     getNewsletters(),
//   ])
