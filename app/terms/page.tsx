      ...
      <div className="flex w-full flex-col border-opacity-50 prose text-pretty dark:prose-invert mx-3 p-4 antialiased space-y-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
            ...
            the Taskful.co.uk Web platform (&quot;Service&quot;). By accessing
            or using the Service, you agree to be bound by these Terms. If you
            do not agree to all the Terms, you may not use the Service. Start
            your project with a Postgres database, Authentication, instant APIs,
          ...
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
            ...
            agree to notify Taskful.co.uk immediately of any unauthorized use of
          ...
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
            ...
            Taskful.co.uk a non-exclusive, royalty-free license to use,
          ...
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
            ...
            Taskful.co.uk&apos;s branding, logos, or legal notices.
          </p>
          <h2 className="text-2xl my-12 py-6  xs:text-center md:text-4xl font-bold text-gray-800 ">
            Third-Party Content
          </h2>
          ...
          <p className="break-words mx-auto xs:mx-6 text-base font-normal mb-4 text-gray-700 antialiased">
          ...
          <p className="break-words mx-auto xs:mx-6 text-base font-normal mb-3 text-gray-700 antialiased">
            THE SERVICE IS PROVIDED &quot;AS IS&quot; AND &quot;AS
            AVAILABLE,&quot; WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED,
            INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY,
            FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
            Taskful.co.uk DOES NOT WARRANT THAT THE SERVICE WILL BE
          ...
          <p className="break-words mx-auto xs:mx-6 text-base font-normal mb-3 text-gray-700 antialiased">
            IN NO EVENT SHALL Taskful.co.uk BE LIABLE FOR ANY DIRECT, INDIRECT,
            ...
            SERVICE, EVEN IF Taskful.co.uk HAS BEEN ADVISED OF THE POSSIBILITY
            OF SUCH DAMAGES.
          </p>
          ...
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
            ...
            Taskful.co.uk regarding the use of the Service.
          </p>
          <h2 className="text-2xl my-9 py-6  xs:text-center md:text-4xl font-bold text-gray-800 ">
            Severability
          </h2>
          <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-12 md:mb-24 text-gray-700 antialiased">
