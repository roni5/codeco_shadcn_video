                ...
                <svg width="1600" height="800">
                  ...
                  <defs>
                    <filter id="turbulent-dissolve" x="0%" y="0%">
                      ...
                      <feImage href="/img/osaka02.jpg" width="800" height="600" result="underlay" />
          ...
          <div className="relative container px-4 mx-auto">
            <div className="w-full lg:w-3/5 lg:pl-16 ml-auto mb-12">
              <div className="ml-2 md:ml-62 py-8 mt-10 lg:mt-20 mb-16 lg:mb-20 max-w-xl">
                <div className="mb-6">
                  <span className="text-sm text-neutral-400 font-medium">Frequent authentication</span>
                </div>
                <h1
                  data-splitting
                ...
                <p className="mb-10 text-lg leading-relaxed text-neutral-300">
                  Transform your workflow with our intuitive platform designed for high-performing teams. Ship faster,
                  collaborate better, and scale with confidence of a professional.
                </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start -my-18 md:-my-4 -mx-6">
                <div className="w-1/2 md:w-1/4 -py-4 md:py-4 px-2 md:px-6 pb-4 md:pb-8">
                  <img className="mx-auto sm:mx-0 h-8 brightness-0 invert" src="darkpro-assets/logos/jiggle-color.svg" alt="" />
                </div>
                <div className="w-1/2 md:w-1/4 p-4 px-6">
                  <img className="mx-auto sm:mx-0 h-8 brightness-0 invert" src="darkpro-assets/logos/symtric-color.svg" alt="" />
                </div>
                <div className="w-1/2 md:w-1/4 p-4 px-6">
                  <img className="mx-auto sm:mx-0 h-8 brightness-0 invert" src="darkpro-assets/logos/wishelp-color.svg" alt="" />
                </div>
                <div className="w-1/2 md:w-1/4 p-0 md:p-4 px-6">
                  <img className="mx-auto sm:mx-0 h-8 brightness-0 invert" src="darkpro-assets/logos/resecurb-color.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
