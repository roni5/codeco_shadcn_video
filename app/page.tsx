						...
						<div className="lg:w-1/2">
							...
							<ul className="space-y-8 md:space-y-10">
								...
								<li className="relative group">
									<div className="flex gap-4 md:gap-6 p-6 rounded-2xl hover:bg-muted/10 transition-all duration-300">
										<div className="flex-shrink-0">
											<div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-linear-to-br from-secondary to-accent flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
												<svg
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 45 45"
													className="w-8 h-8 md:w-9 md:h-9 text-primary-foreground"
								...
								<li className="relative group">
									<div className="flex gap-4 md:gap-6 p-6 rounded-2xl hover:bg-muted/10 transition-all duration-300">
										<div className="flex-shrink-0">
											<div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-linear-to-br from-accent to-primary flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
												<svg
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 45 45"
													className="w-8 h-8 md:w-9 md:h-9 text-primary-foreground"
						...
						<div className="lg:w-1/2">
							...
							<ul className="space-y-8 md:space-y-10 mb-8">
								<li className="relative">
									<div className="p-6 rounded-2xl bg-linear-to-br from-primary/5 to-secondary/5 hover:from-primary/10 hover:to-secondary/10 transition-all duration-300">
