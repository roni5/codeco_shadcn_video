    ...
    <div className=" flex w-full flex-col mx-auto border-opacity-50 antialiased  space-4 ">
      ...
      <div className="max-w-3xl mx-auto">
        <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
          Cookies are small pieces of data which are stored in your browser. These cookies do not hold sensitive data and are simply there to allow this website to function. We do not use third party tracking cookies.
        </p>
        <p className="break-words mx-auto xs:mx-6 text-xl font-normal mb-4 text-gray-700 antialiased">
